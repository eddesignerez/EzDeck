...
object AndroidLanguage {
    private val portuguese = mapOf(
        ...
        "update.invalidPackage" to "A atualização não corresponde ao EzDeck instalado.",
        "update.alreadyDownloading" to "A atualização já está sendo baixada.",
        "update.invalidVersion" to "Versão de atualização inválida.",
        "update.current" to "O EzDeck já está atualizado.",
        "update.permissionTitle" to "Permitir atualização",
        "update.permissionMessage" to "Para atualizar o EzDeck, permita que este app instale a nova versão.",
        "update.cancel" to "Agora não",
        "update.settings" to "Abrir configurações",
        "update.downloadTitle" to "Atualização do EzDeck",
        ...
        "offline.title" to "O EzDeck está fechado no computador",
        "offline.description" to "Abra o aplicativo EzDeck no computador para liberar o dock neste celular.",
        "offline.status" to "Computador desconectado",
        "offline.retry" to "Tentar novamente",
        "offline.hint" to "O celular está funcionando. Só falta abrir o EzDeck no computador.",
    )
    ...
    private val english = mapOf(
        ...
        "update.invalidPackage" to "The update does not match the installed EzDeck app.",
        "update.alreadyDownloading" to "The update is already downloading.",
        "update.invalidVersion" to "Invalid update version.",
        "update.current" to "EzDeck is already up to date.",
        "update.permissionTitle" to "Allow update",
        "update.permissionMessage" to "To update EzDeck, allow this app to install the new version.",
        "update.cancel" to "Not now",
        "update.settings" to "Open settings",
        "update.downloadTitle" to "EzDeck update",
        ...
        "offline.title" to "EzDeck is closed on the computer",
        "offline.description" to "Open the EzDeck app on the computer to enable the dock on this phone.",
        "offline.status" to "Computer disconnected",
        "offline.retry" to "Try again",
        "offline.hint" to "The phone is working. EzDeck just needs to be opened on the computer.",
    )
