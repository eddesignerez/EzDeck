...
| Proteção da branch `main` | Pendente | Deve ser ativada nas configurações do GitHub após a primeira PR de preparação. |
...
2. Em **Settings → Branches**, proteja `main`: exija pull request, testes aprovados e aprovação de mantenedor.
